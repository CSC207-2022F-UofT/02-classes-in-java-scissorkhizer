...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two strings as argument.
     * @param s1 a string representing the first part of this Silly instance's name.
     * @param s2 a string representing the second part of this Silly instance's name, appended to the first part.
     */
